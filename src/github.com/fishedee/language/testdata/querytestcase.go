...
func GetQueryColumnTestCase() []TestCase {
	...
	testCase := []TestCase{
		{
			func() interface{} {
				return QueryColumn([]int{}, " . ")
			},
			[]int{},
		},
		{
			func() interface{} {
				return QueryColumn([]string{"1", "7", "8"}, " . ")
			},
			[]string{"1", "7", "8"},
		},
		{
			func() interface{} {
				return QueryColumn([]ContentType{}, " Name ")
			},
			[]string{},
		},
		{
			func() interface{} {
				return QueryColumn([]ContentType{
		...
		{
			func() interface{} {
				return QueryColumn([]QueryInnerStruct2{
...
func GetQuerySelectTestCase() []TestCase {
	...
	testCase := []TestCase{
		{
			func() interface{} {
				return QuerySelect([]ContentType{},
			...
			func() interface{} {
				return QueryGroup(
					...
					func(list []ContentType) float32 {
						sum := QuerySum(QueryColumn(list, "  Money  ")).(float32)
						return sum
					})
			},
			[]float32{1.1, -2.2, 0},
			...
			func() interface{} {
				return QueryGroup(
					...
					func(list []ContentType) float64 {
						sum := QuerySum(QueryColumn(list, "  CardMoney  ")).(float64)
						return sum
